			...
			<table class="form-table">
				<tr valign="top">
					...
					<td colspan="3">
						...
						<p style="margin:5px 0 0 0;">Add custom jQuery code above, e.g. <code>$( "#accordion" ).accordion();</code> and it will be added automatically to your site. <b>Don't forget to add your jQuery inside the proper wrapper</b> e.g. <code>jQuery(document).ready(function($) { // Add jQuery code here...	});</code></p>
					</td>
				</tr>
				<tr valign="top">
